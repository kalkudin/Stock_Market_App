...
class ProfileFavoriteStocksRecyclerAdapter() : ListAdapter<CompanyDetailsModel, ProfileFavoriteStocksRecyclerAdapter.ProfileFavoriteStocksViewHolder>(DiffCallback){
