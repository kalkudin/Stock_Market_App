...
class GetActivePerformingStocksUseCase @Inject constructor(private val stocksToWatchRepository: StocksToWatchRepository) {
    suspend operator fun invoke() : Flow<Resource<List<StockListItem>>> {
        return stocksToWatchRepository.getActivePerformingStocks()
    }
}